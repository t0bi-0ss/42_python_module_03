...
def players_dict_builder(player_names: list[str], range_max: int) -> dict[str, int]:
    ...
    try:
        ...
        print("Error: range_max must be an int:", msg)
        return None
    if range_max <= 0:
        print("Range max can't be 0 or negative")
        return
